...
export const CAPABILITIES: CapabilityMap = {
  openai: {
    ...
    "extraction.classify": { level: "native" },
    "extraction.annuity": { level: "native" },
    ...
    "fee-analysis": { level: "native" },
    chat: { level: "native", note: "Responses API streaming with previous_response_id session state" },
    dripper: { level: "native" },
    "dripper.client-email": { level: "native" },
    tts: { level: "native" },
    stt: { level: "native" },
  },
  gemini: {
    ...
    "extraction.classify": { level: "native" },
    "extraction.annuity": { level: "native", note: "Native PDF; annuity contract JSON" },
    "intake.turn": { level: "native" },
    ...
    "fee-analysis": { level: "native" },
    chat: { level: "native", note: "generateContentStream; no server-side session state (history replayed each turn)" },
    dripper: { level: "native" },
    "dripper.client-email": { level: "native" },
  ...
  grok: {
    ...
    "extraction.classify": { level: "native" },
    "extraction.annuity": { level: "degraded", note: "PDF rasterized to JPEG" },
    "intake.turn": { level: "native" },
    ...
    "synthesis.json": { level: "native" },
    "fee-analysis": { level: "native" },
    chat: { level: "native", note: "Responses API streaming via OpenAI SDK + baseURL swap" },
    dripper: { level: "native" },
    "dripper.client-email": { level: "native" },
